    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-around">
          <button type="button" @click="resetInputs" class="btn" data-bs-toggle="modal" data-bs-target="#mentorLoginModal">멘토 로그인</button>
          <button type="button" @click="userLogin" class="btn">로그인</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="mentorLoginModal" tabindex="-1" aria-labelledby="mentorLoginModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-around">
          <button type="button" @click="resetInputs" class="btn" data-bs-toggle="modal" data-bs-target="#loginModal">일반 회원 로그인</button>
          <button type="button" @click="mentorLogin" class="btn">로그인</button>
        </div>
      </div>
    </div>
  </div>
